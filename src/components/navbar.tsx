          ...
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu" aria-labelledby="pagesExample">
                <li><a className="dropdown-item" href="https://demos.creative-tim.com/astro-ecommerce/landing/">Landing Page</a></li>
                <li><a className="dropdown-item" href="https://demos.creative-tim.com/astro-ecommerce/product/">Product Page</a></li>
                <li><a className="dropdown-item" href="https://demos.creative-tim.com/astro-ecommerce/shopping-cart/">Shopping Cart</a></li>
              </ul>
            </li>
            <li className="nav-item">
