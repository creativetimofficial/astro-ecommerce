        ...
        <div className="col-12 ">
          ...
          <div className="nav-wrapper position-relative end-0 pb-4 border-bottom">
            <ul className="nav nav-pills nav-fill p-1 w-lg-50" role="tablist">
              ...
              <li className="nav-item">
                <a className="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#second-tab" role="tab" aria-controls="dashboard" aria-selected="false">
                  Material
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#third-tab" role="tab" aria-controls="rating" aria-selected="false">
                  Considerations
                </a>
              </li>
              <li className="nav-item">
                <a className="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#fourth-tab" role="tab" aria-controls="box" aria-selected="false">
                  Included
                </a>
              </li>
            </ul>
            ...
            >
              <div className="row mt-5">
                ...
                <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                  <img className="w-100 rounded-3" src="https://images.unsplash.com/photo-1549400854-b4300f444934?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&q=80" alt="" />
                </div>
              </div>
            </div>
            <div
